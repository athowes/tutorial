# Based on https://cran.r-project.org/web/packages/glmmTMB/vignettes/covstruct.html#a-spatial-covariance-example

# TODO Try priors glmmTMB branch. Currently having a hard time sampling from model without priors
